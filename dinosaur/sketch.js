...
//trampoline
  noStroke();
  fill("black");
    rect(windowWidth/2 - 82, (windowHeight/2) + 200, 10, 100);
    rect(windowWidth/2 -14, (windowHeight/2) + 200, 10, 110);
    rect(windowWidth/2 + 36, (windowHeight/2) + 200, 10, 90);
    rect(windowWidth/2 + 80, (windowHeight/2) + 200, 10, 100);

  fill("DimGrey");
    rect(windowWidth/2 - 100, (windowHeight/2) + 190, 200, 10);
